public partial class FGameData {
    public FGameData() {
        FGameManager.Instance.FGameMessage.Reg<FObjectData>(FMessageCode.CreateObject, OnObjectCreate);
        FGameManager.Instance.FGameMessage.Reg<int>(FMessageCode.RemoveObject, OnObjectRemove);
        FGameManager.Instance.FGameMessage.Reg(FMessageCode.RemoveAllObject, OnAllObjectRemove);
    ...
    public void Clear() {
        FGameManager.Instance.FGameMessage.UnReg<FObjectData>(FMessageCode.CreateObject, OnObjectCreate);
        FGameManager.Instance.FGameMessage.UnReg<int>(FMessageCode.RemoveObject, OnObjectRemove);
        FGameManager.Instance.FGameMessage.UnReg(FMessageCode.RemoveAllObject, OnAllObjectRemove);
